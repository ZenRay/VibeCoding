...
## 更新设计
在 Init 阶段完成后，应该创建好 status.md。这个文档是需要在每个阶段完成后更新该文档，它的作用是整合当前 feature 的进度状态、待解决的问题项等相关的内容，使用中文的方式描述——主要是用于开发人员阅读文档了解项目进度、问题等。执行文档更新的过程，可以考虑采用 hook 的方式。这个部分需要现在 design.md 中更新完后，使用 subagent 完成开发