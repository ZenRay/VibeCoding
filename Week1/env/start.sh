...
echo ""
echo "📋 常用命令："
echo "  查看日志:     $DOCKER_COMPOSE $PROFILES logs -f"
echo "  停止服务:     $DOCKER_COMPOSE $PROFILES down"
echo "  重启服务:     $DOCKER_COMPOSE $PROFILES restart"
echo "  查看状态:     $DOCKER_COMPOSE $PROFILES ps"
echo ""
