...
def upgrade() -> None:
    ...
    if "tickets" not in inspector.get_table_names():
        ...
        op.create_index(
            "idx_tickets_created_at", "tickets", [sa.text("created_at DESC")], unique=False
        )
        op.create_index(
            "idx_tickets_active",
            "tickets",
    ...
    if "ticket_tags" not in inspector.get_table_names():
        ...
        op.create_index(
            op.f("ix_ticket_tags_ticket_id"), "ticket_tags", ["ticket_id"], unique=False
        )
